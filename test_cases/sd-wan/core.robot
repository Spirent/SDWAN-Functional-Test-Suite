...
*** Variables ***
&{TESTCASE_TEMPLATE}    sd-wan.path_selection.001=sd-wan${/}3Stc1Dut_Type01.yaml    sd-wan.resiliency_link.001=sd-wan${/}3Stc1Sne2Dut_Type01.yaml
...
sd-wan.resiliency_link.001
    [Tags]          priority=2
    [Timeout]       1200
    Set Test Variable  ${TEST_CLASS}  sd_wan_resiliency_link_001
    Import Library  testpacks.sd-wan.SD-WAN_Resiliency_Link_Blackout_Local_no_Congestion.sd_wan_resiliency_link_001  ${TEST_DIR}   ${TESTBED_FILE}  WITH NAME  ${TEST_CLASS}
    Run Keyword  ${TEST_CLASS}.setup
    ${RC} =  Run Keyword  ${TEST_CLASS}.run
    Set Test Message  ${RC}