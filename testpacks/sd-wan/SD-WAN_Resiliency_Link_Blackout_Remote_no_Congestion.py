...
class sd_wan_resiliency_link_002(TestBase):
    ...
    def run(self):
        ...
        sneConfigFile = os.path.join(os.path.dirname(os.path.realpath(__file__)),'SD-WAN_Resiliency_Link_Blackout_Remote_no_Congestion_Sne.xml')
