...
*** Variables ***
&{TESTCASE_TEMPLATE}    sd-wan.path_selection.001=sd-wan${/}3Stc1Dut_Type01.yaml    sd-wan.path_selection.002=sd-wan${/}3Stc1Dut_Type01.yaml    sd-wan.resiliency_link.002=sd-wan${/}3Stc1Sne2Dut_Type01.yaml
...
sd-wan.path_selection.002
    [Tags]      priority=1
    [Timeout]   600
    Set Test Variable   ${TEST_CLASS}   path_selection_application_aware_steering
    Import Library  testpacks.sd-wan.Path_Selection_Application_Aware_Steering.path_selection_application_aware_steering   ${TEST_DIR}     ${TESTBED_FILE}  WITH NAME  ${TEST_CLASS}
    Run Keyword     ${TEST_CLASS}.setup
    ${RC} =     Run Keyword     ${TEST_CLASS}.run
    Set Test Message    ${RC}
